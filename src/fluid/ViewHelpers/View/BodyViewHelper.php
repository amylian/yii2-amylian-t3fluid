 ...
 * @author andreas
 */
class BodyViewHelper extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper
{
    ...
    public static function renderStatic(array $arguments, \Closure $renderChildrenClosure, \TYPO3Fluid\Fluid\Core\Rendering\RenderingContextInterface $renderingContext)
    {
        ...
        return $arguments['view']->beginBody().$renderChildrenClosure().$arguments['view']->endBody();
    }
}
